...
@Component({
  ...
  <ion-list>
    <ion-item>
      <ion-input [formControl]="updateBoxForm.controls.boxTitle" data-testid="titleInput">
...
export class UpdateBoxComponent {
  ...
  async submitUpdate() {
    ...
    try {
      const observable =     this.http.put<Box>(environment.baseUrl + '/api/boxes', this.updateBoxForm.getRawValue())
